...
<body class="bg-gray-100 min-h-screen">
    ...
    <nav class="bg-indigo-700 text-white px-8 py-4 flex items-center justify-between shadow-lg">
        ...
        <div class="flex gap-6 text-sm font-medium">
            ...
            <a href="/admin/approvals" class="text-indigo-200 border-b border-indigo-300">
    ...
    <div class="max-w-5xl mx-auto p-8">
        ...
        {{-- Success Alert --}}
        @if(session('success'))
            <div class="bg-green-100 border border-green-200 text-green-700 px-5 py-3 rounded-xl mb-6 flex items-center gap-2">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <div class="flex items-center gap-3">
                <span class="bg-indigo-100 text-indigo-700 px-5 py-2 rounded-full text-sm font-bold">
                    {{ $pendingApprovals }} Pending
                </span>
                <a href="/admin/analytics"
                    class="bg-white border border-gray-200 text-gray-600 px-4 py-2 rounded-xl text-sm hover:bg-gray-50 transition">
        ...
        @if($pendingMessages->isEmpty())
            <div class="bg-white p-16 rounded-2xl shadow-sm border border-gray-100 text-center">
                ...
                <p class="text-gray-400 mb-6">કોઈ પેન્ડિંગ એપ્રોવલ બાકી નથી! 🎉</p>
                <a href="/admin/analytics"
                    class="inline-block bg-indigo-600 text-white px-6 py-2.5 rounded-xl hover:bg-indigo-700 transition font-semibold">
                ...
                <div class="bg-white p-6 mb-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                        <div>
                            ...
                            <div class="bg-gray-50 border border-gray-200 p-4 rounded-xl text-gray-700 text-sm leading-relaxed min-h-16">
                                {{ $msg->user_message }}
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="bg-indigo-50 border border-indigo-100 p-4 rounded-xl text-indigo-800 text-sm leading-relaxed min-h-16">
                                {{ $msg->ai_response }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4 text-xs text-gray-400 mb-4 flex-wrap">
                        ...
                        <span class="bg-yellow-100 text-yellow-700 px-2 py-0.5 rounded-full font-semibold">
                    ...
                    <div class="flex justify-end border-t border-gray-100 pt-4">
                        <form action="/admin/approve/{{ $msg->id }}" method="POST">
                            @csrf
                            <button type="submit"
                                class="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 active:scale-95 text-white px-8 py-2.5 rounded-xl font-semibold transition-all shadow-md shadow-indigo-200">
