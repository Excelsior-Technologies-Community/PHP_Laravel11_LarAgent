    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .sidebar.open { left: 0; }
            .message-user, .message-ai { max-width: 90%; }
        }
    </style>
</head>
<body>
    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="w-full max-w-6xl mx-auto">
            ...
            <div class="text-center mb-6">
                ...
                <p class="text-white opacity-80">Your Intelligent AI Assistant</p>
            </div>

            {{-- Main Chat Container --}}
            <div class="chat-container flex" style="height: 600px;">
                    ...
                    <div class="flex-1 overflow-y-auto p-4">
                        ...
                        <div v-else>
                            <div
                                ...
                                :key="msg.id"
                                class="mb-3 p-2 hover:bg-gray-100 rounded-lg cursor-pointer"
                ...
                <div class="flex-1 flex flex-col min-w-0">
                    ...
                    {{-- Stats Bar --}}
                    <div class="bg-gradient-to-r from-purple-500 to-indigo-600 text-white p-3 flex justify-around items-center flex-shrink-0">
                        <div class="text-center">
                            <div class="text-xs opacity-80">Messages</div>
                        ...
                        <div class="text-center">
                            <div class="text-xs opacity-80">Tools Used</div>
                        ...
                        <div v-for="(msg, index) in messages" :key="index" class="mb-6">
                            ...
                            <div class="flex justify-end mb-2">
                                <div class="message-user">
                                    <div class="text-xs font-medium mb-1 opacity-80">You</div>
                                    <div>@{{ msg.user }}</div>
                                </div>
                            </div>

                            {{-- AI Message --}}
                            <div class="flex justify-start" v-if="msg.ai !== null">
                                <div class="message-ai">
                                    <div v-if="msg.tool" class="tool-badge">
                                        <i class="fas fa-magic"></i> Used: @{{ msg.tool }}
                                    </div>
                                    <div class="text-xs font-medium mb-1 text-gray-500">LarAgent</div>
                    ...
                    <div class="p-4 border-t border-gray-200 bg-white flex-shrink-0">
                        <div class="flex gap-2">
                            <textarea
                                ...
                                class="flex-1 border border-gray-300 rounded-lg px-4 py-2 resize-none focus:outline-none focus:border-purple-500 text-sm"
                                rows="2"
                            ></textarea>
                            <button
                                @click="sendMessage"
                                :disabled="isTyping || !currentMessage.trim()"
                                class="bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-lg px-6 py-2 hover:opacity-90 transition disabled:opacity-50 flex-shrink-0"
                            >
                        ...
                        <div class="text-xs text-gray-400 mt-2">
                            ...
                            Try: "time", "uppercase hello", "5 + 3", "random number", "weather in London"
                        </div>
                    </div>
                </div>
            </div>
